...
- `/youtube videos show` - (admin) posteaza manual videoclipurile din ultima luna fara sa modifice deduplicarea automata; comanda raspunde imediat cu cate videoclipuri a programat, iar livrarea continua in fundal in loturi de maximum 5, cu 10 minute intre loturile suplimentare (nu blocheaza comanda).
