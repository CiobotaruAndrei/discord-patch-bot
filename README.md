...
Addon-ul leaga cinci librarii C/C++: **libmagic** (detectia tipului real, etapa 1), **ZXing-C++** (decodarea codurilor din imagini, inclusiv din imaginile gasite in arhive si din imaginile incorporate in PDF-uri, al caror bitmap e reconstruit din dictionarul obiectului, si din previzualizarea JPEG a unui container HEIC/AVIF cand exista, etapa 9), **libyara** (motorul
