...
- `BOT_ADMIN_ROLE_IDS` - lista separata prin virgula de Discord role ID-uri care primesc acces runtime la comenzile admin, pe langa permisiunea `Administrator`.
