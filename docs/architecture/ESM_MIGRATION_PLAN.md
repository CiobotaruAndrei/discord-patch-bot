...
**incarcarea modulelor in teste**. Au ramas 28 de fisiere din `src/test` care isiincarca modulele prin `createRequire`, fiindca acolo `import` chiar schimba tipul si
