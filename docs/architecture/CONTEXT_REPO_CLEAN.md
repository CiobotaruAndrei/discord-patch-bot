...
- Incarcarea feed-urilor de update-uri si reduceri foloseste acelasi pipeline pentru fetch, persistenta snapshot, validare si fallback. Transformarea payload-ului si regulile de notificare raman in serviciul domeniului.
