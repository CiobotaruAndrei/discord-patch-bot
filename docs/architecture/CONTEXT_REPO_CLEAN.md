...
- **Incarcarea modulelor in teste nu e integral ESM.** 44 de fisiere din `src/test` folosesc `createRequire`, cu plafon descrescator. Codul de productie nu are exceptii.
