...
| `/set anti-raid-alert-channel canal:<canal>` | Admin, Ephemeral, Guild-only | Seteaza canalul anti-raid in care se publica alertele, interventiile, participantii, sanctiunile si erorile incidentului. |
