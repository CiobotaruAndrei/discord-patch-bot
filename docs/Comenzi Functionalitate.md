...
| `/price-alert list` | Admin, Ephemeral | Afiseaza fiecare alerta, pragul, valuta, ultimul pret observat si daca alerta este activa sau inactiva. Alertele pot fi pregatite inainte de `/start reduceri`. |
