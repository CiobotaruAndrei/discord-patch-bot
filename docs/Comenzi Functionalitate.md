...
| `/stop anti-raid confirm:<true>` | Admin, Ephemeral, Guild-only | Opreste modulul anti-raid. Owner-only si cu confirmare obligatorie, fiindca oprirea lasa serverul neprotejat; este diferita de `/anti-raid force-stop`, care doar incheie un incident in curs. |
