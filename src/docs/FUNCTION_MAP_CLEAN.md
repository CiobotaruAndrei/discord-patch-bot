...
- Accepta implicit permisiunea Discord `Administrator` si granturile temporare din `adminAccessCodeGrants`; rolurile sunt acceptate doar daca ownerul serverului seteaza explicit `adminCommandAccess` prin `/set admin-command-access`.
