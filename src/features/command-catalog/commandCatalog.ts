...
export const COMMAND_CATALOG_HELP: readonly CommandCatalogHelpEntry[] = [
  ...
  { command: "/top active games", description: "Afiseaza topul jocurilor active dupa player-count Steam. Daca serverul are jocuri urmarite pentru player-count sau watchlist, topul se limiteaza la acele jocuri.", example: "/top active games numar:5" },
