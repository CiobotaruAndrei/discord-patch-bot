...
export const NOTIFICATIONS_COMMAND_ACCESS: readonly CommandAccessRule[] = [
  ...
  { command: "start", access: "admin", discordAdminPermissions: true, sensitiveSubcommands: ["new-account-alerts", "threat-protection", "threat-delete-risky-files", "threat-delete-policy-violations", "bot-add-protection"] },
  { command: "stop", access: "admin", discordAdminPermissions: true, sensitiveSubcommands: ["new-account-alerts", "threat-protection", "threat-delete-risky-files", "threat-delete-policy-violations", "bot-add-protection"] },
...
export const NOTIFICATIONS_CATALOG_HELP: readonly CommandCatalogHelpEntry[] = [
  ...
  { command: "/start threat-protection", description: "Inspecteaza linkurile si atasamentele. Implicit sterge doar amenintarile confirmate; fisierele executabile/script si incalcarile de politica (@everyone, invitatii) doar alerteaza, fara stergere.", example: "/start threat-protection" },
  { command: "/stop threat-protection", description: "Opreste protectia la amenintari.", example: "/stop threat-protection" },
  { command: "/start threat-delete-risky-files", description: "Politica explicita a serverului: sterge automat mesajele cu fisiere executabile sau script detectate prin continut. Tipul fisierului e confirmat, nu si intentia malware — activeaza doar daca serverul nu asteapta astfel de fisiere.", example: "/start threat-delete-risky-files" },
  { command: "/stop threat-delete-risky-files", description: "Revine la comportamentul implicit: fisierele riscante doar alerteaza, fara stergere automata.", example: "/stop threat-delete-risky-files" },
  { command: "/start threat-delete-policy-violations", description: "Politica explicita a serverului: sterge automat mesajele cu @everyone/@here sau invitatii Discord externe. Sunt incalcari de politica, nu amenintari informatice.", example: "/start threat-delete-policy-violations" },
  { command: "/stop threat-delete-policy-violations", description: "Revine la comportamentul implicit: incalcarile de politica doar alerteaza, fara stergere automata.", example: "/stop threat-delete-policy-violations" },
