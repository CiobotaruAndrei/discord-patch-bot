...
export const NOTIFICATIONS_CATALOG_HELP: readonly CommandCatalogHelpEntry[] = [
  ...
  { command: "/start threat-protection", description: "Inspecteaza linkurile si atasamentele; sterge numai amenintarile confirmate si alerteaza separat cazurile neconfirmate.", example: "/start threat-protection" },
