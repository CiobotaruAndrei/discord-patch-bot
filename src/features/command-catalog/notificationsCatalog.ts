...
export const NOTIFICATIONS_CATALOG_HELP: readonly CommandCatalogHelpEntry[] = [
  ...
  { command: "/stop anti-raid", description: "Opreste modulul anti-raid; owner-only, cu confirmare obligatorie si doar cand exista un incident intr-o etapa de interventie.", example: "/stop anti-raid confirm:true", notes: ["Este alta operatiune decat /anti-raid force-stop, care doar incheie un incident in curs.", "Etapele care permit oprirea sunt confirmed, containment, cleanup si recovery; fara raid tratat comanda refuza si spune de ce.", "Dupa oprire serverul ramane fara detectie de raid."] },
