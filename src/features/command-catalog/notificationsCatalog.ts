...
export const NOTIFICATIONS_CATALOG_HELP: readonly CommandCatalogHelpEntry[] = [
  ...
  { command: "/price-alert list", description: "Listeaza alertele de pret, pragurile, valutele si starea activa sau inactiva; alertele pot fi pregatite inainte de /start reduceri.", example: "/price-alert list" },
