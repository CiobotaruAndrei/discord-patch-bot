...
export function buildNotificationCommandDefinitions({ SlashCommandBuilder, PermissionsBitField }: SlashDefinitionTools): SlashCommandJsonSource[] {
  return [
    ...
    new SlashCommandBuilder()
      ...
      .setDescription("Afiseaza sau gestioneaza jocurile future-release urmarite de bot")
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand(subcommand => subcommand.setName("player-count").setDescription("Porneste urmarirea player-count pentru watchlist sau un joc")
        .addStringOption(option => option.setName("game").setDescription("Optional: limiteaza la un joc").setRequired(false).setAutocomplete(true)))
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand(subcommand => subcommand.setName("player-count").setDescription("Opreste urmarirea player-count pentru server")
        .addStringOption(option => option.setName("game").setDescription("Optional: opreste doar un joc").setRequired(false).setAutocomplete(true)))
