...
export function buildNotificationCommandDefinitions({ SlashCommandBuilder, PermissionsBitField }: SlashDefinitionTools): SlashCommandJsonSource[] {
  return [
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand(subcommand => subcommand.setName("player-count").setDescription("Porneste urmarirea player-count pentru watchlist"))
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand(subcommand => subcommand.setName("player-count").setDescription("Opreste urmarirea player-count pentru watchlist"))
