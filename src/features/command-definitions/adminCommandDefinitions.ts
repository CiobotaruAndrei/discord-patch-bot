  ...
  return [
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand(subcommand => subcommand.setName("anti-raid-thresholds").setDescription("Modifica pragurile anti-raid; optiunile nedate raman la valoarea curenta")
        .addIntegerOption(option => option.setName("identical-messages").setDescription("Mesaje identice sau aproape identice").setRequired(false).setMinValue(2).setMaxValue(50))
        ...
        .addIntegerOption(option => option.setName("invite-messages").setDescription("Mesaje cu invitatii sau reclame").setRequired(false).setMinValue(2).setMaxValue(50))
        ...
        .addStringOption(option => option.setName("coordinated-window").setDescription("Fereastra pentru spam coordonat (ex. 15s)").setRequired(false).setMaxLength(10))
        ...
        .addStringOption(option => option.setName("safety-period").setDescription("Perioada de siguranta fara activitate noua (ex. 30m)").setRequired(false).setMaxLength(10))
