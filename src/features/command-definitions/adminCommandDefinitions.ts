...
export function buildAdminCommandDefinitions({ SlashCommandBuilder, PermissionsBitField, CURRENCY_CHOICES }: SlashDefinitionTools): SlashCommandJsonSource[] {
  return [
    ...
    new SlashCommandBuilder()
      ...
      .addSubcommand(subcommand => subcommand.setName("new-account-alert-channel").setDescription("Seteaza canalul pentru alerte conturi noi")
      ...
      .addSubcommand(subcommand => subcommand.setName("anti-raid-alert-channel").setDescription("Seteaza canalul anti-raid pentru alerte si interventii")
        .addChannelOption(option => option.setName("canal").setDescription("Canalul anti-raid").setRequired(true)))
      .addSubcommand(subcommand => subcommand.setName("anti-raid-thresholds").setDescription("Modifica pragurile anti-raid; optiunile nedate raman la valoarea curenta")
        .addIntegerOption(option => option.setName("duplicate-message-count").setDescription("Mesaje identice sau aproape identice").setRequired(false).setMinValue(2).setMaxValue(50))
        .addStringOption(option => option.setName("identical-window").setDescription("Fereastra pentru mesaje identice (ex. 8s)").setRequired(false).setMaxLength(10))
        .addIntegerOption(option => option.setName("mention-count").setDescription("Numar minim de mentiuni").setRequired(false).setMinValue(2).setMaxValue(100))
        .addStringOption(option => option.setName("mention-window").setDescription("Fereastra pentru mentiuni (ex. 10s)").setRequired(false).setMaxLength(10))
        .addIntegerOption(option => option.setName("server-ad-count").setDescription("Mesaje cu invitatii sau reclame").setRequired(false).setMinValue(2).setMaxValue(50))
        .addStringOption(option => option.setName("invite-window").setDescription("Fereastra pentru invitatii (ex. 20s)").setRequired(false).setMaxLength(10))
        .addIntegerOption(option => option.setName("link-messages").setDescription("Mesaje cu linkuri sau atasamente").setRequired(false).setMinValue(2).setMaxValue(50))
        .addStringOption(option => option.setName("link-window").setDescription("Fereastra pentru linkuri (ex. 12s)").setRequired(false).setMaxLength(10))
        .addIntegerOption(option => option.setName("coordinated-actors").setDescription("Persoane sau boti care participa coordonat").setRequired(false).setMinValue(2).setMaxValue(50))
        .addStringOption(option => option.setName("coordination-window").setDescription("Fereastra pentru spam coordonat (ex. 15s)").setRequired(false).setMaxLength(10))
        .addIntegerOption(option => option.setName("structure-changes").setDescription("Canale sau roluri create ori sterse").setRequired(false).setMinValue(2).setMaxValue(50))
        .addStringOption(option => option.setName("structure-window").setDescription("Fereastra pentru structura (ex. 20s)").setRequired(false).setMaxLength(10))
        .addStringOption(option => option.setName("quiet-period").setDescription("Perioada de siguranta fara activitate noua (ex. 30m)").setRequired(false).setMaxLength(10))
        ...
        .addIntegerOption(option => option.setName("identical-messages").setDescription("Alias vechi pentru duplicate-message-count").setRequired(false).setMinValue(2).setMaxValue(50))
        .addIntegerOption(option => option.setName("invite-messages").setDescription("Alias vechi pentru server-ad-count").setRequired(false).setMinValue(2).setMaxValue(50))
        .addStringOption(option => option.setName("coordinated-window").setDescription("Alias vechi pentru coordination-window").setRequired(false).setMaxLength(10))
        .addStringOption(option => option.setName("safety-period").setDescription("Alias vechi pentru quiet-period").setRequired(false).setMaxLength(10)))
    ...
    new SlashCommandBuilder()
      ...
      .setDefaultMemberPermissions(PermissionsBitField.Flags.Administrator.toString())
      .addChannelOption(option => option.setName("canal").setDescription("Canalul de deblocat").setRequired(true)),
    new SlashCommandBuilder()
      .setName("purge-amount")
      .setDescription("Sterge un numar de mesaje din canalul curent (admin)")
      .setDefaultMemberPermissions(PermissionsBitField.Flags.Administrator.toString())
      .addIntegerOption(option => option.setName("numar").setDescription("Numarul de mesaje (1-100)").setRequired(true).setMinValue(1).setMaxValue(100)),
    new SlashCommandBuilder()
      .setName("purge")
      .setDescription("Sterge mesaje din canalul curent (admin)")
      .setDefaultMemberPermissions(PermissionsBitField.Flags.Administrator.toString()),
    new SlashCommandBuilder()
      .setName("watchlist")
