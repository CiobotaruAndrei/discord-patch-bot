...
export const COMMAND_HELP_ENTRIES: readonly CommandHelpEntry[] = [
  ...
  { command: "/youtube subscribe", permissions: "Admin, Ephemeral", description: "Adauga un canal YouTube in lista urmarita folosind un link, un handle @nume sau un channel ID. Botul memoreaza feed-ul curent ca baseline si nu posteaza retroactiv.", example: "/youtube subscribe canal:@numeCanal" },
