...
export const COMMAND_HELP_ENTRIES: readonly CommandHelpEntry[] = [
  ...
  { command: "/start dlc", permissions: "Admin", description: "Configureaza canalul curent pentru notificarile DLC ale jocurilor active. Motorul automat DLC foloseste aceasta configuratie cand este activ in runtime.", example: "/start dlc" },
  ...
  { command: "/stop dlc", permissions: "Admin", description: "Opreste notificarile DLC si sterge canalul salvat pentru acest modul.", example: "/stop dlc" },
  ...
  { command: "/set add games", permissions: "Admin", description: "Adauga un joc deja cunoscut de bot in lista explicita de jocuri active pentru server.", example: "/set add games joc:cs2", notes: ["Nu adauga un joc nou in codul botului; doar activeaza pentru server un joc existent in configuratie."] },
  { command: "/set remove games", permissions: "Admin", description: "Scoate un joc din lista explicita de jocuri active pentru server.", example: "/set remove games joc:cs2" },
  ...
  { command: "/add watchlist", permissions: "Admin runtime", description: "Adauga un joc deja cunoscut de bot in watchlist-ul serverului.", example: "/add watchlist joc:cs2" },
  { command: "/remove watchlist", permissions: "Admin runtime", description: "Scoate un joc din watchlist-ul serverului.", example: "/remove watchlist joc:cs2" },
