...
import type { ChainableCommandModule } from "./commandChainTestKit.js";
export const installOutboxAdmin = require("../features/command-handlers/outboxAdminHandler").default as
