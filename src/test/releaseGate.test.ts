...
test("release.yml verifica un artifact real de staging smoke, nu doar smoke_confirmed=true", () => {
  ...
  assert.match(text, /actions\/download-artifact@v4/, "descarca artifactul din rularea de staging smoke");
...
test("staging-smoke.yml scrie fisiere de rezultat si urca artifactul", () => {
  ...
  assert.match(text, /actions\/upload-artifact@v4/, "urca artifactul de rezultat");
