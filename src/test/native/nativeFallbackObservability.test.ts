...
test("NATIVE_FALLBACK_FUNCTIONS enumera doar functiile inca native-primary (cele care pot face fallback)", () => {
  for (const fn of ["classifyPatchNote", "scoreListingCandidate", "rankListingCandidates", "extractAndRankListingCandidates", "chooseBestSteamMatch", "isGoodSteamArticleUrl", "extractDateScore"]) {
