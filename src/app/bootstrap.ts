...
function buildAppRuntime(role: BotRole): AppRuntime {
  return createAppRuntime({
    ...
    mongo: {
      ...
      GuildModel: repositories.GuildModel,
      GuildAuditLogModel: repositories.GuildAuditLogModel,
      GuildModerationModel: repositories.GuildModerationModel,
      GuildSecurityModel: repositories.GuildSecurityModel,
      PermissionRequestModel: repositories.PermissionRequestModel,
      ProtectedResourceModel: repositories.ProtectedResourceModel,
      WebhookSnapshotModel: repositories.WebhookSnapshotModel,
      MassModerationModel: repositories.MassModerationModel,
      RaidSnapshotModel: repositories.RaidSnapshotModel,
      RaidIncidentModel: repositories.RaidIncidentModel,
      AuditEntryClaimModel: repositories.AuditEntryClaimModel,
      AdRequestModel: repositories.AdRequestModel,
      AdAttemptModel: repositories.AdAttemptModel,
      NewAccountAlertDeliveryModel: repositories.NewAccountAlertDeliveryModel,
      ChannelLockRecoveryModel: repositories.ChannelLockRecoveryModel,
      raidIntervention: repositories.raidIntervention
    },
    commands, scrapers,
