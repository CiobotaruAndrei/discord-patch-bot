...
- Testele functionale si E2E au fost curatate de identificatorii legacy `ctx` si de tipurile `any`, folosind mock-uri structurale si cast-uri prin `unknown` acolo unde se testeaza input invalid.
